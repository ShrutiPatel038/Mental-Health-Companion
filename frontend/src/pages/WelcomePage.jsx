          ...
          <Card className="card-happy p-6 sm:p-8">
            ...
            {selectedMood && (
              <div className="text-center animate-fade-in">
                <Button
                  className="mt-2 px-4 sm:px-6 py-2 bg-indigo-500 text-white rounded-lg shadow hover:bg-indigo-600 transition"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                  {getRecommendedActivities(selectedMood).map(
                    (activity, index) => (
                      <div
                        key={index}
                        className="bg-white/50 p-4 rounded-2xl text-gray-700"
                      >
                        {activity}
                      </div>
                    )
