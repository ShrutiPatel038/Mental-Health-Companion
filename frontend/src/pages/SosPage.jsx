...
export default function SOSPage() {
  ...
  const handleEmergencyText = (contact) => {
    ...
    const message =
      "Hi, I need support right now. Can you please call me or come over? This is from my MindfulMe app.";
  ...
  const currentHelplines = [
    ...helplines[userLocation],
            ...
            <Card className="mb-8 bg-gradient-to-r from-red-100 to-pink-100 border-red-300 rounded-3xl">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-red-700 mb-4">
                  If you're in crisis or need immediate support, please reach
                  out. Help is available 24/7.
                </p>
                <span className="bg-red-200 text-red-700 text-xs font-large me-2 px-2.5 py-0.5 rounded-full dark:bg-red-900 dark:text-red-300 border border-red-500">
                        ...
                        <CardContent className="p-4">
                          ...
                          <div className="flex space-x-2">
                            ...
                            {helpline.website && (
                              <Button
                                onClick={() =>
                                  window.open(helpline.website, "_blank")
                                }
                                variant="outline"
                                size="sm"
